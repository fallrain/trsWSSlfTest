...
(function(){
  ...
  var rb = function(){
    ...
    if("province" == thisId){	//点击省，构建市的数据
      ...
      $("#addressError").html("");
      buildZones("city");
    }else if("city" == thisId){		//点击市，构建区的数据
  ...
  var buildZones = addressArgs.buildZones =function(selectId){
    ...
    if("" == hiddenProvince || "0," == hiddenProvince){
      hiddenProvince = "-1,";
